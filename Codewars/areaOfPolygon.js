...
It should calculate the area of a regular polygon of numberOfSides a circle of radius circleRadius,
...
function areaOfPolygonInsideCircle(r, n) {
  return Number(((n * (r * r) * Math.sin((2 * Math.PI) / n)) / 2).toFixed(3))
}