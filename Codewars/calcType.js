/*
You have to create a function which receives 3 number arguments:
2 operands a and b, and the result of an unknown operation performed on them.
...
function calcType(a, b, res) {
  ...
  else if((a - b === res) || (b - a === res)) return "subtraction"
  else if((a / b === res) || (b / a === res)) return "division"
...
const calcType = (a, b, res) => {
  return a + b === res ? "addition" : a - b === res || b - a === res ? "subtraction" : a * b === res ? "multiplication" : a / b === res || b / a === res ? "division" : "unknown"
}